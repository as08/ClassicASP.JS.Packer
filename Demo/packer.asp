<script language="JScript" runat="Server">
	...
	/*
		...
		Packer version 1.1 - copyright 2004-2007, Dean Edwards
		http://dean.edwards.name/packer/
		http://www.opensource.org/licenses/mit-license
		
		*** PLEASE NOTE ***
		This vision (1.1) is now depreciated. The current and final version is 3.0
		Be sure to test the function thoroughly before implementing
